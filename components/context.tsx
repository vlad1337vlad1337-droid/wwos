...
import { MOCK_TASKS, MOCK_PRODUCTION, MOCK_INFLUENCERS, MOCK_WAREHOUSE, MOCK_WAREHOUSE_LOGS, MOCK_SHOOTS, MOCK_DESIGN, MOCK_TICKETS, MOCK_REPORTS, MOCK_FINANCE, MOCK_LOGS, MOCK_EXPENSES, MOCK_TEAM, MOCK_SCHEDULE, DEFAULT_EVENT_TYPES } from './constants';
...
export const PlannerProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [design, setDesign] = usePersistedState<DesignProject[]>('design', MOCK_DESIGN);
